...
namespace QMBT
{
	extern FreeListAllocator g_GlobalAllocator;
	...
	void* STLAllocator::allocate(size_t numBytes, int flags)
	{
		...
		return GetGlobalAllocator()->Allocate(numBytes, 8, m_DebugName);
	}
